...
private:
    ...
    //front pointer points to first node in list, tail points to last node 
    CharLinkedList::Node *front, *tail;  
    CharLinkedList::Node *newNode(char c, Node *prev, Node *next); 
    CharLinkedList::Node *movePointer(int index_to_stop) const;
